...
import { onSnapshot, doc, collection, serverTimestamp, addDoc } from "firebase/firestore"
    ...
    return (
        <div>
            {open && (
                <Modal 
                    isOpen={open} 
                    className="max-w-lg w-[90%] absolute top-24 left-[50%] translate-x-[-50%] bg-white border-2 border-gray-500 rounded-xl shadow-md"
                >
                    <div className="p-1">
